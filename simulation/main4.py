...
logging.basicConfig(filename='/home/lames/code/Gcode/FedGraph/log/test.log',
                    filemode="a",
...
if __name__ == '__main__':
    ...
    print(sum, a)
    # 定义模型
    server_model = GCNLP(data.num_node_features, 128, 64).to(device) if args.model == 'GCN' else SageLP(data.num_node_features, 128, 64, 32).to(device)
    ...
    # logging.error('client {}  round {}  epoch {}  name {} model {} acc {} max_acc {}'.format(clientnum, round, epoch, name, args.model, acc_list, max_acc))
